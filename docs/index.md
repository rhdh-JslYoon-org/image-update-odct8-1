...
!!! info
    ...
    **Source Code Repository:** [https://github.com/rhdh-JslYoon-org/image-update-odct8-1](https://github.com/rhdh-JslYoon-org/image-update-odct8-1)

    **GitOps Repository:** [https://github.com/rhdh-JslYoon-org/image-update-odct8-1-gitops](https://github.com/rhdh-JslYoon-org/image-update-odct8-1-gitops)

# **Usage**

To access the image-update-odct8-1 application that was deployed using the Software Template, complete the following instructions:
